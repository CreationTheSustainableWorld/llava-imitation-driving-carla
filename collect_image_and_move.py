...
class World(object):
    ...
    def restart(self, args):
        ...
        self.hud.notification("🔴 Recording Forced On")
...
class CameraManager(object):
    ...
    def _parse_image(weak_self, image):
        ...
        if self.recording:
            image_name = f"{image.frame:08d}.png"

            # ✅ フォルダを作成
            os.makedirs("_out", exist_ok=True)

            image.save_to_disk(f"_out/{image_name}")
            ...
            with open("_out/actions.json", "a") as f:
                f.write(json.dumps({image_name: action}) + "\n")
# ==============================================================================
# -- Game Loop ---------------------------------------------------------
# ==============================================================================
